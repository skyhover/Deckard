...
main   (int argc, char *argv[])
{
   ...
   else
   {
    ...
    //
    lxr        = DotCLexerNew(input);      // CLexerNew is generated by ANTLR
   ...
   if ( dotGraph!=NULL ) {
	   cout << "Graph Name: " << dotGraph->getGraphName() << endl;
	   Graph::printAttributesWithIDs(dotGraph->getAttributes(), "   ", cout);
	   dotGraph->printGraph(cout);
   } else
